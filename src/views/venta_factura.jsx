...
import TablaVentas from '../components/venta_factura/InicioVentaFactura'; // Importa el componente de tabla
...
const Ventas = () => {
  ...
  useEffect(() => {
    const obtenerVentas = async () => {
      try {
        const respuesta = await fetch('http://localhost:3000/api/ventafactura'); // Ruta ajustada al controlador
        if (!respuesta.ok) {
