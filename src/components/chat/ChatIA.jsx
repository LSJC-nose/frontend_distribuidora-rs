...
import { Modal, Button, Form, ListGroup, Table, Spinner } from 'react-bootstrap';
...
const ChatIA = ({ mostrarChatModal, setMostrarChatModal }) => {
  ...
  const enviarMensaje = async () => {
    ...
    try {
      ...
      - Hecho_Venta.fecha_venta -> Dim_Tiempo.fecha_venta 
      Instrucciones: 
      ...
      const response = await fetch('http://localhost:3000/ia/consultarconias', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
